...
export default function ProjectPage({ image, content, href}) {
  ...
  return (
    <Link href={href}>
      <motion.div
        className="relative w-full h-[50vh] lg:h-[400px] bg-[rgba(255,255,255,0.45)] rounded-2xl flex flex-col lg:flex-row shadow-[#00437B] hover:shadow-lg transition-shadow duration-300"
      ...
      >
        {/* 圖片部分 */}
        <div
          className="bg-gray-200 rounded-2xl w-full lg:w-[100vh] h-[50vh] lg:h-[400px]"
          style={{
        ...
        {/* 文字 + 連結部分 */}
        <div className="overflow-hidden w-full lg:w-[80vh] flex flex-col">
          <div className="w-full h-full flex p-6 lg:justify-center lg:items-center text-[#00437B]">
            <p>{content}</p>
          </div>
