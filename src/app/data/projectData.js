...
export const projects = [
...

  {
    ...
    intro_short: '以 Ruby on Rails 8 開發的任務管理 Web 應用程式，提供多使用者環境下的任務追蹤、篩選排序、標籤管理與管理員後台，並以 Hotwire + Tailwind CSS 實現無刷新互動體驗，透過 Kamal 容器化部署。',
  },

  {
    ...
    intro_short: '本專案針對國家考試資訊分散、流程繁複、介面不佳等痛點，規劃一站式服務平台，整合考生報名、備考、應試到錄取分發的完整資訊。事前研究的部分透過問卷、訪談，了解考生在使用現有網站上的經驗和痛點，打造流程清晰、介面易讀的設計，希望提升考生資訊獲取效率與使用體驗。',
...

  {
    ...
    intro_short: '本專案旨在「不變動既有 UI 設計系統」的限制下，全面優化公司官網的內容與使用者體驗。透過用戶與利害關係人訪談及競品分析，重新梳理資訊架構、版面層級與文案策略，並導入 Claude Code 進行程式碼協作，高效完成前台介面變更與動態特效部署。',
  },

  {
    ...
    intro_short: '本專案為 SOSI 官網的 UI 全站更新案，主導識別設計痛點、規劃改版策略，並實際參與前端實作，從品牌形象定義到 Stimulus controller 動畫開發，完成覆蓋全站的 UI 升級。',
  },
...

  {
    ...
    intro_short: '這是一個載入 blender 建模的網頁互動遊戲，可以控制娃娃機爪子抓取機台內娃娃，有機率獲得的獎品類型共有三種，亦有機率失敗沒抓到。',
...

  {
    ...
    intro_short: '本專案為一款以影評為核心的一站式影評＋場次查詢 App UI 設計，針對台灣缺乏整合性影評平台及國外資訊架構複雜的問題，重新規劃符合本地使用習慣的介面。首頁以影評為導覽核心，整合電影資訊與場次查詢功能，並提供探索與個人收藏，提升資訊理解與操作流暢度。',
...

  {
    ...
    intro_short: '此專案為電子產品官網改版優化案，專案內容包含官網的改版、功能的擴充、BUG的排查，以及技術的交接等。我作爲 PM 參與了本專案，負責客戶的需求溝通到實際的功能開發、測試，並進行後續的追蹤，處理功能上線後出現的問題等。',
...

  {
    ...
    intro_short: '此專案為政府教育相關網站的擴充案，相關內容包含介面上的調整、功能新增、篩選機及搜尋機制的改變等。{`\n`}我作爲 PM 參與了本專案，負責專案的需求整理、具體項目規劃等。',
