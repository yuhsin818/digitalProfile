...
export const projects = [
    {
      ...
      intro_short:'此遊戲以「政大流浪狗問題」為主題，結合山坡校園與遺失雨傘等校園日常，打造跑酷動作遊戲。玩家需閃避迎面而來的流浪狗，撿拾雨傘作為防禦道具，最終面對象徵問題根源的最終關卡，反思校園流浪狗議題。',
...

    {
      ...
      intro_short: '本遊戲以「網頁廣告的暗黑模式」為主題，模擬使用者在大量彈窗與廣告干擾中閱讀資訊的情境。玩家需分辨內文、廣告與訂閱陷阱，避免誤觸產生不必要的年費支出，藉此提醒使用者提高對暗黑設計的警覺。',
...

    {
      ...
      intro_short:'《Gacha World》以街頭扭蛋機為靈感，透過生成式藝術的隨機機制，打造不斷變化的可愛扭蛋宇宙。觀者點擊畫面即可觸發「轉扭蛋」，即時生成具表情、造型與稀有度差異的扭蛋，並與隨機生成的扭蛋機連動，形成如遊戲般的互動體驗。',
...

    {
      ...
      flow: [
        ...
        {
          img: final02,
          text: "進入體驗區，對準畫面中央站，偵測到人後會自動開始播放前導動畫第二部分。",
        },
        {
          img: final03,
    ...
    
    {
      ...
      intro_short:'本專案為一款以影評為核心的一站式影評＋訂票 App UI 設計，針對台灣缺乏整合平台及國外資訊架構複雜的問題，重新規劃符合本地使用習慣的介面。首頁以影評為導覽核心，整合電影資訊、場次查詢與訂票功能，並提供探索與個人收藏，提升資訊理解與操作流暢度。',
  
      intro: `本專案為一款以影評為核心的一站式影評＋訂票 App UI 設計。針對台灣缺乏整合性影評平台、國外資訊結構複雜與影評與訂票流程分離等問題，重新規劃符合台灣使用習慣的介面架構。首頁以影評作為主要導覽入口，整合電影資訊、場次查詢與訂票連結，並提供探索與個人收藏功能，提升整體使用流暢度與資訊理解效率。本作品以 UI 視覺與操作流程設計為主，未進行實際使用者測試，未來可作為後續 UX 驗證與優化基礎。`,
