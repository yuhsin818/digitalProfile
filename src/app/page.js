      ...
      <div className="w-full flex justify-start">
        ...
        >
          ...
          <div className="text-[#00437B] lg:w-1/2 p-5 pl-8">
            ...
            <p className="">我畢業於政大心理學系，雙主修數位內容、輔系日文，具備心理知識、設計思維與數位技術整合的跨領域背景。以使用者經驗設計為核心，結合網頁開發與數位互動裝置實作，擅長從使用者行為與情緒出發，規劃介面流程與互動體驗。在學校曾參與多項互動與數位創作專案，具有從企劃到實作的製作經驗。期望能持續深化技術能力，創造兼具美感與實用性的數位體驗！</p>
          </div>
        </motion.div>
