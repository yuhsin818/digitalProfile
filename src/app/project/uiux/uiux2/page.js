      ...
      <div className="flex flex-col w-full gap-6 justify-center items-center p-4 sm:p-[60px] sm:pl-[100px] pt-[30px]">
        ...
        <div className="w-full flex flex-row gap-4 p-2">
          ...
          <div className="flex flex-col">
            ...
            本專案為一款以「影評為主導，訂票為輔助」的一站式電影 App UI 設計。針對目前的市場進行觀察，目前台灣多以社群媒體分享、部落格影評或零散影評文章為主，缺乏一個具整合性與公信力的影評平台； 而國外影評網站資訊層級複雜，可能不符合台灣使用習慣； 且我們認為現有平台中，影評平台與場次查詢、訂票功能未整合，導致使用者需多次跳轉，增加使用負擔。{`\n`}
因此，本專案目標是打造符合台灣使用習慣的一站式影評＋訂票平台，並致力於簡化影評瀏覽與電影資訊查詢流程，建立清楚、直覺且具有一致性的介面結構，為使用者提供更流暢、高效的電影探索與購票流程。
            </p>
          </div>
        </div>
